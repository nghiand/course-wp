...
$students_list_heading = apply_filters('learn_press_students_list_heading', __('students enrolled', 'thim'));
    ...
    <div class="course-students-list">
        ...
        <?php if ($students = $course->get_students_list(true, $student_limit)): ?>
            <ul class="students">
                ...
                if ($other_student) {
                    echo '<p>'.__('and', 'thim').' ' . sprintf(_n('one student enrolled.', '%s '.__('students enrolled', 'thim'), $other_student, 'learnpress'), $other_student) . '</p>';
                }
                ?>
            </ul>
        <?php else: ?>
