...
$purchase_button_text = apply_filters( 'learn_press_purchase_button_text', __( 'Take this course', 'learnpress' ) );
...
?>
	...
	<?php elseif ( $user->can( 'enroll-course', $course->id ) ) : ?>
		<form name="enroll-course" class="enroll-course" method="post" enctype="multipart/form-data">
			...
			<button id="learn_press_take_course" class="btn button enroll-button" data-block-content="yes"><?php echo $enroll_button_text; ?></button>
