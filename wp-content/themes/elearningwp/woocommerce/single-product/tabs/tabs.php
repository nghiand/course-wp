				...
				foreach ( $tabs as $key => $tab ) :
					...
					<div class="panel panel-description">
						<div class="panel-heading">
							<p class="panel-title">
								<a <?php if ( $i !== 1 ) { echo 'class="collapsed"';} ?> data-toggle="collapse" data-parent="#accordion" href="#tab-<?php echo esc_attr($key) ?>"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', $tab['title'], $key ) ?></a>
							</p>
						</div>
						<div id="tab-<?php echo esc_attr($key) ?>" class="panel-collapse collapse <?php if ( $i == 1 ) {
							echo "in";
						} ?>">
