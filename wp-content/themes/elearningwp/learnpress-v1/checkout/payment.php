...
$payment_heading              = apply_filters( 'learn_press_checkout_payment_heading', __( 'Payment Method', 'thim' ) );
$order_button_text            = apply_filters( 'learn_press_order_button_text', __( 'Place order', 'thim' ) );
$order_button_text_processing = apply_filters( 'learn_press_order_button_text_processing', __( 'Processing', 'thim' ) );
$show_button                  = true;
?>
...
<div id="learn-press-payment" class="learn-press-checkout-payment">
	<?php if ( LP()->cart->needs_payment() ): ?>
		...
		<?php if ( empty( $available_gateways ) ): $show_button = false;?>
			...
			<?php if ( $message = apply_filters( 'learn_press_no_available_payment_methods_message', __( 'No payment methods is available.', 'thim' ) ) ) { ?>
