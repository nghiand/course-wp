	...
	<table class="learn-press-cart-table">
		<thead>
			<tr>
				...
				<th class="course-name"><?php _e( 'Course', 'thim' ); ?></th>
				<th class="course-price"><?php _e( 'Price', 'thim' ); ?></th>
				<th class="course-total"><?php _e( 'Total', 'thim' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		?>
		<tr>
			<td colspan="3"><?php _e( 'Subtotal', 'thim' );?></td>
			<td><?php echo $cart->get_subtotal();?></td>
		</tr>
		<tr>
			<td colspan="3"><?php _e( 'Total', 'thim' );?></td>
			<td><?php echo $cart->get_total();?></td>
		</tr>
		<?php do_action( 'learn_press_after_cart_contents' ); ?>
		</tbody>
	</table>
	<button class="checkout-button"><?php _e( 'Checkout', 'thim' );?></button>
