...
<?php if ( $quiz->has( 'questions' ) ) { ?>
	...
	<a href="<?php echo get_the_permalink( $quiz->id ); ?>" target="_blank"><?php _e( 'Do this quiz', 'thim' ); ?></a>

<?php } else { ?>

	<?php learn_press_display_message( __( 'This quiz has not got any questions', 'thim' ), 'error' ); ?>
