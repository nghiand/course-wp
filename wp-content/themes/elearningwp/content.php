...
$column_product = 3;
if ( isset( $theme_options_data['thim_archive_cate_grid_column'] ) && $theme_options_data['thim_archive_cate_grid_column'] <> '' ) {
	$column_product = 12 / $theme_options_data['thim_archive_cate_grid_column'];
}
$classes   = array();
