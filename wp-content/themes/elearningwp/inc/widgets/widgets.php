...
include_once( TP_THEME_DIR . '/inc/widgets/collapse/collapse.php' );
...
include_once( TP_THEME_DIR . '/inc/widgets/courses/courses.php' );
include_once( TP_THEME_DIR . '/inc/widgets/post-display/post-display.php' );
include_once( TP_THEME_DIR . '/inc/widgets/testimonials/testimonials.php' );
include_once( TP_THEME_DIR . '/inc/widgets/courses-searching/courses-searching.php' );
include_once( TP_THEME_DIR . '/inc/widgets/course-categories/course-categories.php' );
include_once( TP_THEME_DIR . '/inc/widgets/top-instructors/top-instructors.php' );
include_once( TP_THEME_DIR . '/inc/widgets/courses/courses.php' );
include_once( TP_THEME_DIR . '/inc/widgets/buddypress/buddypress.php' );
include_once( TP_THEME_DIR . '/inc/widgets/tweets-feed/tweets-feed.php' );
include_once( TP_THEME_DIR . '/inc/widgets/form-login/form-login.php' );
include_once( TP_THEME_DIR . '/inc/widgets/thim-recent-comments/thim-recent-comments.php' );
include_once( TP_THEME_DIR . '/inc/widgets/slider/slider.php' );
include_once( TP_THEME_DIR . '/inc/widgets/instructor-of-month/instructor-of-month.php' );
