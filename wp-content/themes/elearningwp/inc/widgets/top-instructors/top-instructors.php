...
class Top_Instructors_Widget extends Thim_Widget {
	...
	function __construct() {
		parent::__construct(
			'top-instructors',
			__( 'Thim: Top Instructors', 'thim' ),
			array(
				'description' => __( 'Show top instructors who created popular courses.', 'thim' ),
				'help'        => '',
			...
			array(
				'heading_group'    => array(
					...
					'fields' => array(
						'title'               => array(
							...
							'default'               => __( "Top Instructors", "thim" ),
				...
				'limit' => array(
					'type'    => 'number',
					'label'   => __( 'Number Of Instructors', 'thim' ),
					'default' => '4'
				)
			)
		);
