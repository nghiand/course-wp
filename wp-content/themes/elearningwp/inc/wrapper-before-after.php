...
if ( !function_exists( 'thim_wrapper_loop_start' ) ) :
	function thim_wrapper_loop_start() {
		...
		$sidebar_class = '';
		if ( is_buddypress_use_page() || is_404() ) {
			$class_col = 'col-sm-12 full-width';
		}
		...
		echo '<div class="container site-content' . $sidebar_class . $class_no_padding . '"><div class="row"><main id="main" class="site-main ' . $class_col . '" role="main">';
	}
endif;
