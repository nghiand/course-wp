...
function customcss() {
	...
	$color_opacity                   = thim_hex2rgb( $thim_options['thim_body_primary_color'] );
	$thim_body_primary_color_opacity = 'rgba(' . $color_opacity[0] . ',' . $color_opacity[1] . ',' . $color_opacity[2] . ',0.7)';
	$icon_box                        = 'rgba(' . $color_opacity[0] . ',' . $color_opacity[1] . ',' . $color_opacity[2] . ',0.8)';
	$overlay_primary                        = 'rgba(' . $color_opacity[0] . ',' . $color_opacity[1] . ',' . $color_opacity[2] . ',0.85)';
	$custom_css                      = '';
	...
	if ( isset( $thim_options['thim_footer_background_img'] ) && $thim_options['thim_footer_background_img'] ) {
		...
		$custom_css .= '.footer {background-image: url("' . $bg_footer[0] . '");
 						background-position: ' . $thim_options['thim_footer_bg_position'] . ';
						background-repeat: no-repeat;
 		}';
	}

 	$custom_css .= '.gallery-img .item a .mark {background-color:   ' . $thim_body_primary_color_opacity . '}';
 	$custom_css .= '.overlay-primary:before {background-color:   ' . $overlay_primary . '}';
	$custom_css .= '.iconbox-hover:hover .thim-widget-icon-box {background-color:   ' . $icon_box . '!important}';
...
function themeoptions_variation( $data ) {
	$theme_options = array(
		...
		'thim_font_h6',
		'thim_width_logo',
		'thim_margin_bottom_logo',
		'thim_margin_top_logo',
		'thim_margin_top_header',
